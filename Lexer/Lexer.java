...
public class Lexer {
    ...
    /**
     * Function that reads and returns
     * a character from the given stream
    ...
    public Token lexical_scan(BufferedReader br) {
        ...
        switch (peek) {
            ...
            case '+':
                ...
                break;
                /**
                 * Tutto ciò che segue non serve: non è 
                 * compito del lexer verificare che il token
                 * sia usato correttamente.
                 * Il lexer deve limitarsi a riconoscere il token.
                 * Quindi non deve preoccuparsi di controllare
                 * se, ad esempio, il simbolo di divisione sia seguito
                 * da una costante numerica
                 */
                /*
                try {
                    ...
                    br.mark(1000);
                    readch(br);
                    // non importa sapere il simbolo successivo
                    // possa davvero essere tokenizzato come numero
                    // basta che sia una cifra numerica
                    // non è compito del lexer fare l'analisi sintattica
                ...
                try {
                    ...
                    if (peek == '/')
                    {
                        ...
                        do {
                            symbol = peek; 
                            readch(br);
                            // Invariante: peek == ultimo carattere letto && symbolo == penultimo carattere letto
                            if (peek == (char) -1) {
            ...
            case '<':
                ...
                try {     
                    /*
                        The mark function allows us to mark
                        a point of the stream so that we can
                        go back to it.
                        By doing so, we can evaluate the next character
                        of the input stream without consuming it.
                        This is necessary for the symbols, such as <, that may
                        or may not be followed by another symbol (such as =) to
                        form a particular combination.
                    */       
                ...
                if (Character.isLetter(peek) || peek == '_') { // neither keyword nor identifiers can start with numers
                    try {
                        ...
                        do {
                            ...
                            aus += peek;
                            readch(br);
                        } while (Character.isLetterOrDigit(peek) || peek == '_'); // we read all the word's symbols to form the lexem
